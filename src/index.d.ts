...
declare namespace protoflex {
    ...
    class InputMessage {
        ...
        /**
         * Serialize [[InputMessage]] to [Uint8Array](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array)
         */
        toUint8Array (): Uint8Array

        /**
         * Serialize [[InputMessage]] to [ArrayBuffer](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer)
         */
     ...
     * can be read.
     *
     * **NOTE** that it is technically impossible to re-encode arbitrary Protobuf
     * message, thus OutputMessage is read-only
     */
    class OutputMessage {
         ...
         * Thus, to provide possibility of parsing those fields, this method is added.
