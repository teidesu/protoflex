...
function () {
  ...
  _createClass(InputMessage, [{
    ...
    key: "editMessage",
    value: function editMessage(key, cb) {
      var index = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
      ...
      if (!(key in this.fields) || !this.fields[key][index]) {
        throw new Error("".concat(key, ":").concat(index, " does not exist"));
      }

      var field = this.fields[key][index];
      var msg;
      ...
      if (field.type === 'lengthDelimited') {
        ...
        try {
          ...
          throw new Error("Failed to parse ".concat(key, ":").concat(index, " as message: ").concat(e));
        }
      ...
      if (field.type !== 'message') {
        throw new Error("".concat(key, ":").concat(index, " is not a message"));
      }
...
var OutputMessage = __webpack_require__(11);

var InputMessage = __webpack_require__(9);
          ...
          if (val.type === 'varint') {
            ...
            (function () {
              var obj = {
                ...
                value: val._buffer ? val._buffer : _this6.data.slice(val.value.start, val.value.end)
              };

              obj.tryToInput = function () {
                return new OutputMessage(obj.value, new Deserializer(obj.value).parse()).toInput();
              };
...
function () {
  function Serializer(msg) {
    var keepDefault = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
